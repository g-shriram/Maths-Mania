    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ans.equals("?")||ans.equals(""))
                    Toast.makeText(Multiplayer.this, "Answer please !!!", Toast.LENGTH_SHORT).show();
                else{
                ...
                try {
                    if (dataSnapshot != null) {
                        ...
                        if (qa.size() > 20) {
                            ...
                            score1.setText(max);
                            customQuesAdapter = new CustomPlayerAdapter(Multiplayer.this, qa, uname);
                    ...
                    Toast.makeText(Multiplayer.this, "Host ended the game !", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(Multiplayer.this, android.R.style.Theme_Material_Light_NoActionBar_Fullscreen);
                alertDialog.setTitle("Confirm");
                alertDialog.setMessage("Want to stop Game ?");
                LayoutInflater factory = LayoutInflater.from(Multiplayer.this);
